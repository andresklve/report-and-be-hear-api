...
public class TestimonioServiceImplement implements ITestimonioService {
    ...
    @Override
    public void insert(Testimonio testimonio) { tR.save(testimonio); }

    @Override
    public List<Testimonio> list() { return tR.findAll(); }

    @Override
    public void update(Testimonio testimonio) { tR.save(testimonio); }

    @Override
    public void delete(Long idTestimonio) { tR.deleteById(idTestimonio); }

    @Override
    public Optional<Testimonio> listId(Long id) { return tR.findById(id); }
}
